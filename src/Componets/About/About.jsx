				...
				<div className="about__block">
					...
					<div className="about__content">
						<div className="about__inform">
							...
							<div className="wow animate__shakeX title title-fz36" data-wow-duration="1.2s" data-wow-delay="1.5s">
							...
							<div className="about__text">
								Я web-розробник, i створюю чудові веб-сайти, які домогають виділитися серед конкурентів. Якщо ви шукаєте роботу, або плануєте розвивати / розпочати свій бізнес, вам потрібен веб-сайт із правильною структурою, i в цьому я можу бути для вас корисним. Можу і вмію створити портфоліо / веб-сайт  вашої мрії з професійним підходом, який буде відповідати вимогам сучасності, вашій справі і вашій індивідуальності.
							</div>
						</div>
