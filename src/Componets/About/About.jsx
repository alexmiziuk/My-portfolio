				...
				<div className="about__block">
					...
					<div className="about__content">
						<div className="about__inform">
							...
							<div className="about__text">
								Я web-розробник i створюю веб-сайти, які домогають виділитися серед конкурентів. Ви шукаєте роботу, або плануєте розвивати <span>/</span> розпочати свій бізнес? Тоді вам потрібен веб-сайт із правильною структурою. І в цьому я можу бути для вас корисним. Створю портфоліо <span>/</span> веб-сайт  вашої мрії з професійним підходом, який буде відповідати вимогам сучасності, вашій справі і вашій індивідуальності.
							</div>
						</div>
					...
					<div className="about__technologies">
							...
							<div className="about__technology">
								...
								<div className="about__content-tech">Я отримую велике задоволення від того, що створюю веб-застосунки. Я хочу, щоб їх використовували у повсякденному житті, або професійній діяльності.</div>
							</div>
							<div className="about__technology">
								<div className="about__icon">
