	...
	return (
		<div className={privacy ? 'privacy visible' : 'privacy'} id='privacy' >
			...
			<div className="container">
				...
				<p>Ця політика обробки персональних даних складена відповідно до вимог Про захист персональних даних
					Закону України від 01.06.2010 № 2297-VI (далі — Закон про персональні дані) та визначає порядок обробки персональних даних та заходи щодо забезпечення безпеки персональних даних, які вживає Мізюк Олександр Миколайович (далі — Оператор).<br></br> <br />
					...
					1.2. Ця політика Оператора щодо обробки персональних даних (далі — Політика) застосовується до всієї інформації, яку Оператор може отримати про відвідувачів веб-сайту https://my-porfolio.</p>
				...
				<p>
					...
					2.2. Блокування персональних даних — тимчасове припинення обробки персональних даних (крім випадків, якщо обробка необхідна уточнення персональних даних). <br></br>
					2.3. Веб-сайт — сукупність графічних та інформаційних матеріалів, а також програм для ЕОМ та баз даних, що забезпечують їх доступність у мережі інтернет за адресою https://my-porfolio. <br></br>
					...
					2.8. Персональні дані — будь-яка інформація, що стосується безпосередньо або опосередковано до певного або визначеного Користувачеві веб-сайту https://my-porfolio. <br></br>
					...
					2.10. Користувач – будь-який відвідувач веб-сайту https://my-porfolio. <br></br>
					2.11. Надання персональних даних - дії, спрямовані на розкриття персональних даних певній особі чи певному колу осіб. <br></br>
				...
				<p>5.1. Обробка персональних даних здійснюється на законній та справедливій основі.<br></br>
					...
					5.7. Зберігання персональних даних здійснюється у формі, що дозволяє визначити суб'єкта персональних даних, не довше, ніж цього вимагають мети обробки персональних даних, якщо термін зберігання персональних даних не встановлений законом України, договором, стороною якого вигодонабувачем або поручителем за яким є суб'єкт персональних даних. Оброблювані персональні дані знищуються чи знеособлюються після досягнення цілей обробки чи разі втрати потреби у досягненні цих цілей, якщо інше передбачено законом України.</p>
				<h2>
				...
				<p>
					...
					7.2. Обробка персональних даних необхідна досягнення цілей, передбачених міжнародним договором держави Україри чи законом, реалізації покладених законодавством України на оператора функцій, повноважень і обов'язків.<br></br>
				...
				<p>
					...
					12.3. Актуальна версія Політики у вільному доступі розміщена у мережі Інтернет за адресою https://my-porfolio.
				</p>
			</div>
			<ArrowScrollUp />
		</div >
